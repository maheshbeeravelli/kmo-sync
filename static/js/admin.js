...
// Grab the files and set them to our variable
  ...
  $( 'select[name="offer_type"]' ).change(function() {
    var enable_coupon = ["Coupon","iCoupon"];
    if(enable_coupon.indexOf($(this).val()) > -1)
    {
      $('input[placeholder="Coupon Code"]').removeAttr("disabled","")
    }
    else
    {
      $('input[placeholder="Coupon Code"]').attr("disabled","")
    }
  });
  // $('input[placeholder="Coupon Code"]').removeAttr("disabled","")
  
//Other Useful Handler Functions  
